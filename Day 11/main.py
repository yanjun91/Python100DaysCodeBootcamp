...
def print_current_score(player_card, computer_card):
...
def black_jack_game():
    ...
    player_cards = []
    computer_cards = []
    for _ in range(2): # Draw 2 cards initially
    ...
    while play_game:
        ...
        if user_score == 0 or computer_score == 0 or user_score > 21:
            ...
            if another_card == "y":
                ...
                play_game = False
    if play_game or 'computer_score' in locals(): # Check if currently playing game or if computer_score variable exist
