...
SHEETY_GET_USER_ENDPOINT = "https://api.sheety.co/06a9ee1734ad5334a87ca74d54cf36b1/flightDeals/users"
...
class DataManager:
    ...
    def get_emails(self):
        response = requests.get(url=SHEETY_GET_USER_ENDPOINT, headers=self.sheety_headers)
        data = response.json()
        return data["users"]
